...
def main():
	createFigures(parse(json.load(open('small_graph.json'))))
	createFigures(parse(json.load(open('big_graph.json'))))
	createFigures(parse(json.load(open('custom_graph.json'))))
	createFigures(parse(json.load(open('custom_graph2.json'))))
	createFigures(parse(json.load(open('custom_graph3.json'))))
	plt.show()
